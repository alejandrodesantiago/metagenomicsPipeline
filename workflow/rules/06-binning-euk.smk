...
rule euk_metabat:
    ...
    params:
        bin=scratch_dir + "01-analysis/14-eukmags/02-metabat2/bins"
    conda:
        "../envs/metabat2.yaml"
    shell:
        '''
...
#        Rscript {params.dastool}/DAS_Tool.R -i {output.metabat},{output.concoct} -l metabat,concoct -c {input.contigs} -o {output.dastool}/{params.basename} --write_bins --write_bin_evals --score_threshold 0 -t 4 --customDbDir={params.database} --useCustomDbOnly
#        '''
