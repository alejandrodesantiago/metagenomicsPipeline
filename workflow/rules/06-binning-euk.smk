...
rule euk_dastool:
    ...
    shell:
        ...
        #srun {params.dastool}/DAS_Tool -i {output.metabat},{output.concoct} -l metabat,concoct -c {input.contigs} -o {output.dastool}/{params.basename} --write_bins 1 --customDbDir {params.database} --useCustomDbOnly --search_engine diamond
        '''
