...
rule euk_dastool:
    ...
    shell:
        ...
        srun {params.dastool}/Fasta_to_Contig2Bin.sh -i {params.metabat} -e fa > {output.metabat}
        srun {params.dastool}/Fasta_to_Contig2Bin.sh -i {input.concoct} -e fa > {output.concoct}
