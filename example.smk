...
rule all:
    input:
        ...
        trimmomatic=expand(scratch_dir + "01-analysis/03-trimmomatic/{sample}.r1.fastq.gz", sample=SAMPLES) # run trimmomatic
...
rule trimmomatic:
    ...
    output:
        r1_paired=scratch_dir + "01-analysis/03-trimmomatic/{sample}.r1.fastq.gz",
        r2_paired=scratch_dir + "01-analysis/03-trimmomatic/{sample}.r2.fastq.gz",
        r1_unpaired=scratch_dir + "01-analysis/03-trimmomatic/{sample}.r1.unpaired.fastq.gz",
        r2_unpaired=scratch_dir + "01-analysis/03-trimmomatic/{sample}.r2.unpaired.fastq.gz"
    params:
